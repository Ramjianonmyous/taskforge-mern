    ...
    <div className="app-container">
      ...
      <div className="main-content">
        ...
        <div className="page-container">
          ...
          {currentPage === 'tasks' && <TasksPage user={currentUser} tasks={tasks} users={users} loading={loading} onTaskUpdate={loadData} showToast={showToast} forceOpenModal={openTaskModal} onCloseModal={() => setOpenTaskModal(false)} />}
